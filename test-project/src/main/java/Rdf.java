...
import eu.neverblink.protoc.java.runtime.RepeatedByte;
...
public final class Rdf {
  ...
  public static final class RdfStreamFrame extends ProtoMessage<RdfStreamFrame> implements Cloneable {
     ...
     */
    private RepeatedMessage<RdfStreamRow> rows = null;

    /**
     * <code>repeated .eu.ostrzyciel.jelly.core.proto.v1.RdfStreamFrame.MetadataEntry metadata = 15;</code>
     */
    private RepeatedMessage<MetadataEntry> metadata = null;
    ...
    private void initRows() {
      if (rows == null) {
        rows = RepeatedMessage.newEmptyInstance(RdfStreamRow.getFactory());
      }
    }
     ...
     * @return internal storage object for reading
     */
    public RepeatedMessage<RdfStreamRow> getRows() {
      initRows();
      return rows;
    }
     ...
     * @return internal storage object for modifications
     */
    public RepeatedMessage<RdfStreamRow> getMutableRows() {
      initRows();
      bitField0_ |= 0x00000001;
      return rows;
    }
     ...
     * @return this
     */
    public RdfStreamFrame addAllRows(final RdfStreamRow... values) {
      initRows();
      bitField0_ |= 0x00000001;
      rows.addAll(values);
      return this;
    ...
    private void initMetadata() {
      if (metadata == null) {
        metadata = RepeatedMessage.newEmptyInstance(MetadataEntry.getFactory());
      }
    }
     ...
     * @return internal storage object for reading
     */
    public RepeatedMessage<MetadataEntry> getMetadata() {
      initMetadata();
      return metadata;
    }
     ...
     * @return internal storage object for modifications
     */
    public RepeatedMessage<MetadataEntry> getMutableMetadata() {
      initMetadata();
      bitField0_ |= 0x00000002;
      return metadata;
    }
     ...
     * @return this
     */
    public RdfStreamFrame addAllMetadata(final MetadataEntry... values) {
      initMetadata();
      bitField0_ |= 0x00000002;
    ...
    public RdfStreamFrame copyFrom(final RdfStreamFrame other) {
      ...
      if ((bitField0_ | other.bitField0_) != 0) {
        ...
        if (other.hasMetadata()) {
          initMetadata();
          metadata.copyFrom(other.metadata);
        } else {
          clearMetadata();
        }
      }
    ...
    public void writeTo(final CodedOutputStream output) throws IOException {
      if ((bitField0_ & 0x00000001) != 0) {
        for (int i = 0; i < rows.length(); i++) {
          output.writeRawByte((byte) 10);
          output.writeMessageNoTag(rows.get(i));
        }
      }
      if ((bitField0_ & 0x00000002) != 0) {
        for (int i = 0; i < metadata.length(); i++) {
          output.writeRawByte((byte) 122);
          output.writeMessageNoTag(metadata.get(i));
        }
      }
    }
    ...
    protected int computeSerializedSize() {
      int size = 0;
      if ((bitField0_ & 0x00000001) != 0) {
        size += (1 * rows.length()) + CodedOutputStream.computeRepeatedMessageSizeNoTag(rows);
      }
      if ((bitField0_ & 0x00000002) != 0) {
        size += (1 * metadata.length()) + CodedOutputStream.computeRepeatedMessageSizeNoTag(metadata);
      }
      return size;
    }
    ...
    public static final class MetadataEntry extends ProtoMessage<MetadataEntry> implements Cloneable {
       ...
       */
      private RepeatedByte value_ = null;
      ...
      private void initValue() {
        if (value_ == null) {
          value_ = RepeatedByte.newEmptyInstance();
        }
      }
       ...
       * @return this
       */
      public MetadataEntry addAllValue(final byte... values) {
        initValue();
        bitField0_ |= 0x00000002;
